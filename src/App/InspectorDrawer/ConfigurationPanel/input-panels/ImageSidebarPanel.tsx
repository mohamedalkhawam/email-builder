...
import { type ImageProps, ImagePropsSchema } from 'components/block-image';
...
export default function ImageSidebarPanel({ data, setData }: ImageSidebarPanelProps) {
  ...
  return (
    <BaseSidebarPanel title='Image block'>
      ...
      <TextInput label='Alt text' defaultValue={data.props?.alt ?? ''} onChange={(alt) => updateData({ ...data, props: { ...data.props, alt } })} />
      <TextInput
