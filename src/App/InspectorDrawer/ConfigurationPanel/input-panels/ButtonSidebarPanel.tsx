...
import { type ButtonProps, ButtonPropsDefaults, ButtonPropsSchema } from 'components/block-button';
...
export default function ButtonSidebarPanel({ data, setData }: ButtonSidebarPanelProps) {
  ...
  return (
    <BaseSidebarPanel title='Button block'>
      ...
      <RadioGroupInput label='Size' defaultValue={size} onChange={(size) => updateData({ ...data, props: { ...data.props, size } })}>
