...
import { type AvatarProps, AvatarPropsDefaults, AvatarPropsSchema } from 'components/block-avatar';
...
export default function AvatarSidebarPanel({ data, setData }: AvatarSidebarPanelProps) {
  ...
  return (
    <BaseSidebarPanel title='Avatar block'>
      ...
      <MultiStylePropertyPanel names={['textAlign', 'padding']} value={data.style} onChange={(style) => updateData({ ...data, style })} />
    </BaseSidebarPanel>
  );
}
